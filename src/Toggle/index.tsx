...
export const Toggle = ({ value, onToggle, dark = true }: ToggleProps) => (
    <div onClick={() => onToggle(!value)} className={`w-12 h-6 px-0.5 ${dark ? 'bg-blue-darker' : 'bg-gray-200'} rounded-full shadow-inner-sm flex flex-row items-center cursor-pointer`}>
